...
// בסוף נוודא שהאיבר שנשארנו איתו באמת מקיים את התנאי של הרוב


//O(1) מקום O(N)  הדרך האחרונה היא הכי יעילה- זמן
//אבל לא כל כך אינטואטיבית, אני אממש כאן את הטבלת האש
